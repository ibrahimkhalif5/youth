        ...
        <div class="container">
            <div class="row ">
                <div class="col-md-4 py-5 bg- text-white text-center "
                    style="background-image: url('front/images/mak.jpeg'); background-size: contain; background-repeat: no-repeat; background-position: cover;">
                    <!-- <div class=" ">
                        <div class="card-body">
                ...
                <div class="col-md-8 py-5 border">
                    ...
                    <form class="" method="POST" action="{{url('university-placement')}}" id="postComment"
