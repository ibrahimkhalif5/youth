...
<div class="content_wrapper">
                        ...
                        <ul>
                            ...
                            <li data-index="rs-310" data-transition="slideoverhorizontal" data-slotamount="default"
                                ...
                                <div class="tp-caption BigBold-Title tp-resizeme rs-parallaxlevel-0"
                                  ...
                                  white-space: nowrap;">Our Football Team
                                </div>
                            ...
                            <li data-index="rs-310" data-transition="slideoverhorizontal" data-slotamount="default"
                                ...
                                <div class="tp-caption BigBold-Title tp-resizeme rs-parallaxlevel-0"
                                    ...
                                    data-transform_out="y:[100%];s:1000;e:Power2.easeInOut;s:1000;e:Power2.easeInOut;"
                                    data-basealign="slide" data-responsive_offset="off" style="z-index: 6; 
                                  white-space: nowrap;">Department of SOCIAL SERVICES
                                </div>
                            ...
                            <li data-index="rs-310" data-transition="slideoverhorizontal" data-slotamount="default"
                                ...
                                <div class="tp-caption BigBold-Title tp-resizeme rs-parallaxlevel-0"
                                    ...
                                    data-transform_out="y:[100%];s:1000;e:Power2.easeInOut;s:1000;e:Power2.easeInOut;"
                                    data-basealign="slide" data-responsive_offset="off" style="z-index: 6; 
                                  white-space: nowrap;">Mandera Football Team
                                </div>
            ...
            <div class="course_wrapper">
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12" style="background-color: #eeeee4">
                    <div class="course_block">
                        <div class="img_wrap">
                            <img alt="Science" src="front/images/science.jpg">
    ...
    <div id="count" class="count" data-stellar-background-ratio="0.3"
        style="background: url(front/images/count_bg.jpg); background-attachment: fixed; background-position: 50% 50%;">
        <div class="container">
            <div class="head_part">
